"""
Django settings for avalita project.
...
# TODO: be cautious about this secret key
...
WSGI_APPLICATION = 'avalita.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './avalita.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
